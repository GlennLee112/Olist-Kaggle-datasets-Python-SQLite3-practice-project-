...
# Reference :
# The following are reference used in
# https://stackoverflow.com/questions/71345245/frame-inside-a-oop-tkinter-frame

# Explanation of inheritance and Object-Oriented Programming (included ChatGPT explanation):
# https://www.geeksforgeeks.org/python/python-super-with-__init__-method/
# https://chatgpt.com/s/t_68a536130ed48191a98a91986ae606e7
# https://chatgpt.com/s/t_68a5358d45648191bebc057a0279ca5c
...
class Application(Tk):
    def __init__(self):
        ...
        self.title_frame_widget = Query_frame(self.title_frame)
...
class Query_frame(Frame):
    def __init__(self,parent):
        ...
        self.title_frame.grid(row=0, column=0, columnspan=2, pady=10, padx=10)
        # Instantiate and pack the TitleFrame
        self.title_frame_widget = TitleFrame(self.title_frame)
        self.title_frame_widget.grid(row=0, column=0)
        ...
        self.date_selector_widget = DateSelectorFrame(self.date_frame)
